...
void createMatrix1()
{
    ...
    int nrows3 = 480, ncols3 = 640;
    cv::Mat m3_8u;
    m3_8u.create(nrows3, ncols3, CV_8UC3);
    ...
    */
    ...
    string windowName3 = "First steps in Open CV (m3_8u)";
    cv::namedWindow(windowName3, 1);
    cv::imshow(windowName3, m3_8u);
    cv::waitKey(0);
